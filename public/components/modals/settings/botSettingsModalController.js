...
(function() {
  ...
  function BotSettingsModalController(authService, $q, $http, $location, $log, $scope, $timeout, $mdDialog, songRequestService) {
  ...
  BotSettingsModalController.$inject = ['authService', '$q', '$http', '$location', '$log', '$scope', '$timeout', '$mdDialog', 'songRequestService'];

  angular
    .module('uiApp')
    .controller('BotSettingsModalController', BotSettingsModalController);
